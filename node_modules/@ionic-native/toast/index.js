...
var Toast = (function (_super) {
    ...
    Toast.prototype.show = /**
       ...
       * @returns {Observable<any>}  Returns an Observable that notifies first on success and then when tapped, rejects on error.
       */
    function (message, duration, position) { return; };
    /**
    ...
    /**
       ...
       * @returns {Observable<any>}  Returns an Observable that notifies first on success and then when tapped, rejects on error.
       */
    Toast.prototype.showShortCenter = /**
       * Shorthand for `show(message, 'short', 'center')`.
       * @param message {string}
       * @returns {Observable<any>}  Returns an Observable that notifies first on success and then when tapped, rejects on error.
       */
    ...
    /**
       ...
       * @returns {Observable<any>}  Returns an Observable that notifies first on success and then when tapped, rejects on error.
       */
    Toast.prototype.showShortBottom = /**
       * Shorthand for `show(message, 'short', 'bottom')`.
       * @param message {string}
       * @returns {Observable<any>}  Returns an Observable that notifies first on success and then when tapped, rejects on error.
       */
    ...
    /**
       ...
       * @returns {Observable<any>}  Returns an Observable that notifies first on success and then when tapped, rejects on error.
       */
    Toast.prototype.showLongCenter = /**
       * Shorthand for `show(message, 'long', 'center')`.
       * @param message {string}
       * @returns {Observable<any>}  Returns an Observable that notifies first on success and then when tapped, rejects on error.
       */
    ...
    /**
       ...
       * @returns {Observable<any>}  Returns an Observable that notifies first on success and then when tapped, rejects on error.
       */
    Toast.prototype.showLongBottom = /**
       * Shorthand for `show(message, 'long', 'bottom')`.
       * @param message {string}
       * @returns {Observable<any>}  Returns an Observable that notifies first on success and then when tapped, rejects on error.
       */
